import"./modulepreload-polyfill-B5Qt9EMX.js";import{b as E,C as f,V as _,aO as k,aP as X,at as D,a2 as L,av as N,U as B,aF as V,z as G}from"./MaterialBase-BpiTyhsa.js";import{g as I}from"./lil-gui.module.min-BH_YJbPT.js";import{m as M,u as U,g as A}from"./ggx_functions.glsl-BPuHaSoe.js";class Z extends E{get graphFunctionSnippet(){return this._graphFunctionSnippet}set graphFunctionSnippet(n){this._graphFunctionSnippet=n}constructor(n){super({blending:X,transparent:!1,depthWrite:!1,depthTest:!1,defines:{USE_SLIDER:0},uniforms:{dim:{value:!0},thickness:{value:1},graphCount:{value:4},graphDisplay:{value:new k(1,1,1,1)},overlay:{value:!0},xRange:{value:new _(-2,2)},yRange:{value:new _(-2,2)},colors:{value:[new f(15277667).convertSRGBToLinear(),new f(5025616).convertSRGBToLinear(),new f(240116).convertSRGBToLinear(),new f(16761095).convertSRGBToLinear()]}},vertexShader:`
		...
		`,this.setValues(n)}onBeforeCompile(n){return n.fragmentShader=n.fragmentShader.replace("__FUNCTION_CONTENT__",this._graphFunctionSnippet),n}customProgramCacheKey(){return this._graphFunctionSnippet}}const z=`
	#include <common>
	${M}
	${U}
	${A}
...
`;let b,C,i,c,a,e=10,R,g;const r={aspect:1,displayX:!0,displayY:!0,displayZ:!0,displayW:!0,reset(){e=10,a.set(-e*.5+e*.05,d()*e*.5-e*.05)}};P();async function P(){g=document.getElementById("dataContainer"),R=document.getElementById("data"),i=new D({antialias:!0}),i.setSize(window.innerWidth,window.innerHeight),i.setClearColor(1119772),i.setPixelRatio(window.devicePixelRatio),i.setAnimationLoop($),document.body.appendChild(i.domElement),b=new L,b.position.set(0,0,1.5),C=new N,a=new _,c=new B(new V,new Z({side:G,thickness:1,graphFunctionSnippet:z})),c.scale.setScalar(2),C.add(c),a.set(-e*.5+e*.05,d()*e*.5-e*.05);const o=new I;o.add(c.material,"dim"),o.add(c.material,"thickness",.5,10),o.add(r,"aspect",.1,2),o.add(r,"reset");const n=o.addFolder("graphs");n.add(r,"displayX").name("display graph 1"),n.add(r,"displayY").name("display graph 2"),n.add(r,"displayZ").name("display graph 3"),n.add(r,"displayW").name("display graph 4");let s=!1,p=-1,h=-1;i.domElement.addEventListener("pointerleave",()=>{g.style.visibility="hidden"}),i.domElement.addEventListener("pointerenter",()=>{g.style.visibility="visible"}),i.domElement.addEventListener("pointerdown",t=>{s=!0,p=t.clientX,h=t.clientY}),i.domElement.addEventListener("pointermove",t=>{if(s=s&&!!(t.buttons&1),s){const m=t.clientX-p,v=t.clientY-h;p=t.clientX,h=t.clientY;const y=1,x=d(),w=e*y*m/window.innerWidth,u=e*x*v/window.innerHeight;a.x+=w,a.y+=u}g.style.left=`${t.clientX}px`,g.style.top=`${t.clientY}px`;const l=H(t.clientX,t.clientY);R.innerText=`x: ${l.x.toFixed(3)}
y: ${l.y.toFixed(3)}`}),i.domElement.addEventListener("wheel",t=>{const l=t.clientX,m=t.clientY,v=1,y=d(),x=l/window.innerWidth-.5,w=m/window.innerHeight-.5,u=e*v*x,W=e*y*w,F=e,S=Math.pow(.95,1);t.deltaY<0?e*=S:e/=S,e=Math.max(e,.1),e=Math.min(e,100);const T=u*e/F,Y=W*e/F;a.x-=u-T,a.y-=W-Y}),window.addEventListener("resize",()=>{i.setSize(window.innerWidth,window.innerHeight)})}function $(){const o=c.material,n=1,s=d();o.xRange.set(-a.x-.5*n*e,-a.x+.5*n*e),o.yRange.set(a.y-.5*s*e,a.y+.5*s*e),o.graphDisplay.set(Number(r.displayX),Number(r.displayY),Number(r.displayZ),Number(r.displayW)),i.render(C,b)}function d(){return r.aspect*window.innerHeight/window.innerWidth}function H(o,n){const p=d(),h=o/window.innerWidth-.5,t=n/window.innerHeight-.5,l=e*1*h-a.x,m=e*p*t-a.y;return{x:l,y:-m}}
